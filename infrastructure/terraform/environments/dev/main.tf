...
# Database Migration is handled by the deployment script (scripts/deploy-infrastructure.sh)
# No Terraform resource needed - migration runs via migrate-database-simple.sh script